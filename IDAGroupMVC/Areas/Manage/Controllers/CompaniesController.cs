...
namespace IDAGroupMVC.Areas.Manage.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        private void PosterImageCheck(Company company)
        {
            ...
            if (company.PosterImageFile.Length > 41943040)
            {
                ModelState.AddModelError("PosterImageFile", "PosterImageFile max size is 40MB");
            }
        }
        private void ImagesCheck(Company company)
        {
            foreach (var image in company.ImageFiles)
            {
                ...
                {
                    ModelState.AddModelError("ImageFiles", "PosterImageFile max size is 40MB");
                    break;
                }
            }
        }
