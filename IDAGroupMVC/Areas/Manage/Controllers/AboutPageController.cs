...
namespace IDAGroupMVC.wwwroot.uploads.settings.about
{
    ...
    public class AboutPageController : Controller
    {
        ...
        public async Task<IActionResult> Edit(Setting about)
        {
            ...
            Setting aboutExist = await _context.Settings.Where(x => x.IsDelete == false).FirstOrDefaultAsync(x => x.Id == about.Id);
        ...
        private void PosterImageCheck(Setting about)
        {
            ...
            if (about.KeyImageFile.Length > 41943040) ModelState.AddModelError("KeyImageFile", "Image max size is 40MB");
        }
    }
}