...
namespace IDAGroupMVC.Areas.Manage.Controllers
{
    ...
    public class ContactPageController : Controller
    {
        ...
        {
            var contact = _context.Settings.Where(x => x.IsDelete == false).AsQueryable();
        ...
        private void PosterImageCheck(Setting setting)
        {
            ...
            if (setting.KeyImageFile.Length > 41943040) ModelState.AddModelError("KeyImageFile", "Image max size is 40MB");
        }
    }
}